...
chartkick::chartkick(data = linechart_df, xcol = "dates",
...
chartkick::chartkick(data = pc_df, xcol = "V1", ycol = "V2",
...
chartkick::chartkick(data = cc_df, xcol = "V1", ycol = "V2", type = "ColumnChart",legend = FALSE, colors = list("purple", "red", "green"))

# bar chart ---------------
bar_data <- jsonlite::fromJSON('[["Work", 352], ["Play", 1492]]')
bd_df <- as.data.frame(bar_data)
chartkick::chartkick(data = bd_df, xcol = "V1", ycol = "V2",type = "BarChart", legend = FALSE, colors = list("green","red"))
...
chartkick::chartkick(data = ac_df, xcol = "Date", ycol = "Value",
...
chartkick::chartkick(data = sc_df, xcol = "V1", ycol = "V2",
